...
public class UnconcealedExtendedUnwoundedScroll extends UnwoundedScrollItem {
    public UnconcealedExtendedUnwoundedScroll(ToolMaterial material, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        user.addStatusEffect(new StatusEffectInstance(MoreWeaponryCompat.UNWOUNDED, 740, 0));
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.incantation.unconcealed.unwounded.extended").formatted(Formatting.BLUE));
    }
}
