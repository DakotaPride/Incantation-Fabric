package net.dakotapride.incantation.compat.moreweaponry.item.items_modified;
...
public class SweetUnconcealedUnwoundedScroll extends UnwoundedScrollItem {
    public SweetUnconcealedUnwoundedScroll(ToolMaterial material, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        user.addStatusEffect(new StatusEffectInstance(MoreWeaponryCompat.UNWOUNDED, 460, 0));
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.incantation.unconcealed.unwounded").formatted(Formatting.BLUE));
