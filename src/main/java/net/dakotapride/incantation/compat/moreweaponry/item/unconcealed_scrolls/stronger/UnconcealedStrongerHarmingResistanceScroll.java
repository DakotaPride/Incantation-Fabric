...
public class UnconcealedStrongerHarmingResistanceScroll extends HarmingResistanceScrollItem {
    public UnconcealedStrongerHarmingResistanceScroll(ToolMaterial material, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        user.addStatusEffect(new StatusEffectInstance(MoreWeaponryCompat.HARMING_RESISTANCE, 460, 1));
