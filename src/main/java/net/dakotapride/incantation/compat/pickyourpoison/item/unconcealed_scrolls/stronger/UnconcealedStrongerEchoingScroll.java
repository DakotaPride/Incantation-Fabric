...
public class UnconcealedStrongerEchoingScroll extends EchoingScrollItem {
    public UnconcealedStrongerEchoingScroll(ToolMaterial material, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        user.addStatusEffect(new StatusEffectInstance(PickYourPoisonCompat.ECHOING, 460, 1));
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.incantation.unconcealed.echoing.strong").formatted(Formatting.BLUE));
    }
}
