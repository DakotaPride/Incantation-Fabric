...
public class IncantationTags {
        ...
        public static final TagKey<StatusEffect> PICK_YOUR_POISON_EFFECTS = createPickYourPoisonStatusEffectTag("pick_your_poison_effects");

        private static TagKey<Item> createCommonItemTag(String name) {
            return TagKey.of(Registry.ITEM_KEY, new Identifier("c", name));
        }

        private static TagKey<StatusEffect> createPickYourPoisonStatusEffectTag(String name) {
