...
public class UnconcealedFrostedBleakScroll extends BleakScrollItem {
    public UnconcealedFrostedBleakScroll(ToolMaterial material, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.incantation.unconcealed.bleak.frosted").formatted(Formatting.BLUE));
