...
public class SweetUnconcealedRaWrathScroll extends RaWrathScrollItem {
    public SweetUnconcealedRaWrathScroll(ToolMaterial material, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.incantation.unconcealed.ra_wrath").formatted(Formatting.BLUE));
